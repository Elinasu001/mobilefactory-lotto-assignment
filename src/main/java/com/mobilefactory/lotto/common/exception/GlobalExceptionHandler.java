...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResponseData<Object>> handleInvalidAuthCode(
    ...
    public ResponseEntity<ResponseData<Object>> handleAuthCodeExpired(
            AuthCodeExpiredException e) {
        log.warn("인증번호 만료: {}", e.getMessage());
        return ResponseData.failure(e.getMessage(), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(AuthRequiredException.class)
    public ResponseEntity<ResponseData<Object>> handleAuthRequired(
            AuthRequiredException e) {
    ...
    public ResponseEntity<ResponseData<Object>> handleEventNotFound(
    ...
    public ResponseEntity<ResponseData<Object>> handleEventNotStarted(
            EventNotStartedException e) {
        log.warn("이벤트 기간 아님: {}", e.getMessage());
        return ResponseData.failure(e.getMessage(), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(AlreadyParticipatedException.class)
    public ResponseEntity<ResponseData<Object>> handleAlreadyParticipated(
            AlreadyParticipatedException e) {
        log.warn("중복 참여: {}", e.getMessage());
        return ResponseData.failure(e.getMessage(), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(ExceedMaxParticipantsException.class)
    public ResponseEntity<ResponseData<Object>> handleExceedMaxParticipants(
            ExceedMaxParticipantsException e) {
    ...
    public ResponseEntity<ResponseData<Object>> handleParticipantNotFound(
    ...
    public ResponseEntity<ResponseData<Object>> handleAnnounceNotStarted(
            AnnounceNotStartedException e) {
    ...
    public ResponseEntity<ResponseData<Object>> handleForcedWinnerNotFound(
            ForcedWinnerNotFoundException e) {
        log.warn("1등 지정 번호 미참여: {}", e.getMessage());
        return ResponseData.failure(e.getMessage(), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(WinnerAlreadyGeneratedException.class)
    public ResponseEntity<ResponseData<Object>> handleWinnerAlreadyGenerated(
            WinnerAlreadyGeneratedException e) {
        log.warn("당첨자 이미 생성됨: {}", e.getMessage());
        return ResponseData.failure(e.getMessage(), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(NotEnoughCandidatesException.class)
    public ResponseEntity<ResponseData<Object>> handleNotEnoughCandidates(
            NotEnoughCandidatesException e) {
    ...
    public ResponseEntity<ResponseData<Object>> handleSmsSendFailed(
            SmsSendFailedException e) {
    ...
    public ResponseEntity<ResponseData<Object>> handleIllegalArgumentException(
    ...
    public ResponseEntity<ResponseData<Object>> handleMediaTypeNotSupported(
