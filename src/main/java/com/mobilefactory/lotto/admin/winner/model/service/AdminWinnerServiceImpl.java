...
import com.mobilefactory.lotto.admin.winner.model.dao.AmindWinnerMapper;
...
public class AdminWinnerServiceImpl implements AdminWinnerService {
    ...
    private final AmindWinnerMapper adminWinnerMapper;
    ...
    public WinnerGenerationResponse generateWinners(GenerateWinnersRequest request) {
        ...
        log.info("1등: {}명, 2등: {}명, 3등: {}명, 4등: {}명",
            rank1Count, rank2Count, rank3Count, rank4Count);
